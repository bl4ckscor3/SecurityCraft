...
public class RegistrationHandler {
	...
	public static void registerBlockEntities(RegistryEvent.Register<BlockEntityType<?>> event) {
		...
		event.getRegistry().register(BlockEntityType.Builder.of(BlockChangeDetectorBlockEntity::new, SCContent.FRAME.get()).build(null).setRegistryName(new ResourceLocation(SecurityCraft.MODID, "frame")));
	}
